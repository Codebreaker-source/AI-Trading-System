...
#property description "Bridge EA - FULL TRADE EXECUTION"
...
{
    Print("================================================================");
    Print("  BridgeEA_LITE_v2_16 - FULL TRADE EXECUTION");
    Print("================================================================");
    ...
    Print("SUCCESS: BridgeEA v2.16 initialized");
...
void OnDeinit(const int reason)
{
    ...
    Print("BridgeEA v2.16 deinitialized");
}
...
void ProcessTradeCommands()
{
    ...
    while(!FileIsEnding(handle))
    {
        ...
        {
            if(LogVerbose)
                Print("Skipping duplicate command: ", symbol, " ", action);
            continue;
        }
