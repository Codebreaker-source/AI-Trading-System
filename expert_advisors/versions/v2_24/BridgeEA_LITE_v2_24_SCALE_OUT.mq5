//+------------------------------------------------------------------+
//|                           BridgeEA_LITE_v2_24_SCALE_OUT.mq5       |
//|                                            AI Trading System      |
...
#property description "Bridge EA - SCALE_OUT SUPPORT"
#property description "NEW: SCALE_OUT action for partial position close (0.01 lots)"
#property description "FIX: Delete command file after execution (no duplicates)"
#property description "FIX: MaxLotSize = 0.04 with hard cap enforcement"
...
{
    Print("================================================================");
    Print("  BridgeEA_LITE_v2_24 - SCALE_OUT SUPPORT");
    Print("================================================================");
    Print("  NEW: SCALE_OUT action for partial close");
    Print("  FIX: Delete command file after execution");
    ...
    Print("SUCCESS: BridgeEA v2.24 initialized");
...
void OnDeinit(const int reason)
{
    ...
    Print("BridgeEA v2.24 deinitialized");
}
