//+------------------------------------------------------------------+
//|                           BridgeEA_LITE_v2_29_REGIME_TRAIL.mq5     |
//|                                            AI Trading System      |
//|     REGIME-ADAPTIVE TRAILING STOP UPDATE                          |
//+------------------------------------------------------------------+
#property copyright "AI Trading System"
#property link      ""
#property version   "2.29"
#property description "Bridge EA v2.29 - REGIME-ADAPTIVE TRAILING"
#property description "NEW: Trailing distance adapts to market regime"
#property description "NEW: Ranging=1.5x, Trending=2.5x, Volatile=3.5x ATR"
#property description "KEEP: Drawdown scaling from v2.28"
#property description "KEEP: All v2.27 risk management features"
...
void ManageOpenPositions()
{
    ...
    for(int i = 0; i < total; i++)
    {
        ...
        double atr = GetATRValue(symbol);
        double trail_multiplier = GetRegimeTrailMultiplier(symbol, atr);  // NEW v2.29: Regime-adaptive
