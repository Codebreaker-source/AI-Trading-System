//+------------------------------------------------------------------+
//|                              BridgeEA_LITE_v2_28_DRAWDOWN.mq5      |
//|                                            AI Trading System      |
//|     DRAWDOWN-BASED POSITION SCALING UPDATE                        |
//+------------------------------------------------------------------+
#property copyright "AI Trading System"
#property link      ""
#property version   "2.28"
#property description "Bridge EA v2.28 - DRAWDOWN-BASED POSITION SCALING"
#property description "NEW: Tiered max positions based on drawdown"
#property description "NEW: Uses WORST of (total DD) vs (daily DD)"
